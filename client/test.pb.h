...
#ifndef PROTOBUF_client_2ftest_2eproto__INCLUDED
#define PROTOBUF_client_2ftest_2eproto__INCLUDED
...
class Void : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_client_2ftest_2eproto();
  friend void protobuf_AssignDesc_client_2ftest_2eproto();
  friend void protobuf_ShutdownFile_client_2ftest_2eproto();
...
public:
  Test(InterProcessChannel *ipc) : impl_(ipc) {}

  PID GetPID(void) {
    Void params;
    return GetPID(params);
  }

  PID GetPID(const Void &params) {
    return impl_.CallSync<Void, PID>(kGetPID, params);
  }

  void GetPID( ::std::function<void(const PID&)> cb) {
    Void params;
    GetPID(params, cb);
  }

  void GetPID(const Void &params, ::std::function<void(const PID&)> cb) {
    impl_.CallAsync<Void, PID>(kGetPID, params, cb);
  }

  Time GetTime( ::std::string value) {
    Text params;
    params.set_value(value);
    	return GetTime(params);
  }

  Time GetTime(const Text &params) {
    return impl_.CallPushSync<Text, Time>(kGetTime, params);
  }

  void GetTime( ::std::string value, ::std::function<bool(const Time&)> cb) {
    Text params;
    params.set_value(value);
    GetTime(params, cb);
  }

  void GetTime(const Text &params, ::std::function<bool(const Time&)> cb) {
    impl_.CallPushAsync<Text, Time>(kGetTime, params, cb);
  }
...
#endif  // PROTOBUF_client_2ftest_2eproto__INCLUDED
